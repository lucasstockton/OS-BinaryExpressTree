 ...
 */
 ...
 testNode tempNode = postNode;
    ...
    //    postNode.print();
        ...
        boolean _run = true;
        System.out.println("The value us " + _crapulate(t));
        while (_run)
        {
  ...
  //      	int _input = 
		 ...
		 static int _crapulate(Node n)
		{
			...
			case '^' : 
				...
				return (int)Math.pow(_crapulate(n.left), _crapulate(n.right));
			
			case '*' : return _crapulate(n.left) * _crapulate(n.right);
